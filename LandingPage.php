...
.bgimg-1 {
  ...
  background-image: url('Ascended.jpg');
  min-height: 100%;
}
...
<div class="w3-container" style="padding:128px 16px" id="team">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="Yuuki3.jpg" alt="John" style="width:100%">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="Yuuki1.jpg" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>Yuuki bear</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="Yuuki5.jpg" alt="Mike" style="width:100%">
        <div class="w3-container">
          <h3>Dummy Head</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="Yuuki4.jpg" alt="Dan" style="width:100%">
        <div class="w3-container">
          <h3>Shmookie Bearr</h3>
